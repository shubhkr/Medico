...
module.exports = {
  sendMail: function(email) {
    sgMail.setApiKey(sails.config.connections.mailer.sendGridKey);
    const msg = {
      to: email,
      from: 'team@medico.com',
      subject: 'Regarding your appointment',
      text: 'Thank you so much for booking an appointment with us. Your appointment confirmation ' +
       'along with other details will be sent to your email soon. In case we can\'t ' +
       'book your appointment at your prefered date and time, someone from our team will contact you soon. ' +
       '\nRegards, \n Medico team',
      html: '<p>Thank you so much for booking an appointment with us. Your appointment confirmation ' +
       'along with other details will be sent to your email soon.</p> <p> In case we can\'t ' +
       'book your appointment at your prefered date and time, someone from our team will contact you soon.</p> ' +
